...
- Підготуйте файли .ogg 16 kHz, Stereo/Mono відповідно до таблиці фраз. Можна створити лише 5-10 найпопулярніших фраз. Інші фрази будуть взяті з пакету-донора.
