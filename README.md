...
* tar.gz пакет підходить для роботів пилососів Dreame, Mijia та Mova якщо є можливість завантаження у [специфікації](https://home.miot-spec.com) робота пилосмока
