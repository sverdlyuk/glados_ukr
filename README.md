...
* `.pkg` пакет працює з Roborock першого та другого поколінь v1, M1S, S4, S5, S5e, S6, S6_MaxV, S6_Pure, T6;
* `.tar.gz` пакет для пилосмока Xiaomi пртестований на пилосмоці Xiaomi s20 plus;
