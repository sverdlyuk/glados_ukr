...
## 🚀Особливості
* Повна українська переозвучка: у пакеті для Dreame (tar.gz) переозвучені 199 оригінальних фраз робота. У пакеті Roborock (.pkg) 97 фраз.
...
* Пакет для пилосмока Xiaomi в процесі розробки
