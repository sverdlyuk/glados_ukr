...
Щоб створити власний голосовий пакет для Midea, достатньо підготувати теку з аудіофайлами у форматі .mp3. Кожен файл має відповідати таким параметрам:
 ...
 Назви файлів повинні відповідати цифрам, які вони озвучують. Більше деталей — у файлі мапінгу команд Midea. Також для зручності тут лежать оригінальні звукові файли Midea M7 Pro
