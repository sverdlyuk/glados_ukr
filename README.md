...
Голосовий пакет Xiaomi — це архів `tar.gz`, який містить `.mp3` файли без папок (усі файли розміщені просто в корені архіву). Усі файли названі цифрами. Кожна така цифра відповідає конкретній фразі. Детальніше дивись мапінг команд Xiaomi. Бітрейт файлів становить 96 кбіт/с. Частота дискретизації — 44,1 кГц або 16,0 кГц.
