...
|-----------|----------------|-----------------------------------------------------------------------------------------------------------|
| Roborock  | .pkg           | пилососи першого та другого поколінь v1, M1S, S4, S5, S5e, S6, S6 MaxV, S6 Pure, T6                                                            |
| Dreame    | tar.gz         | Усі моделі, що підтримують завантаження голосового пакету у [специфікації](https://home.miot-spec.com)  |
...
* `.tar.gz` пакет для пилосмока Xiaomi протестований на пилосмоці Xiaomi s20 plus `xiaomi.vacuum.b108gl`;
