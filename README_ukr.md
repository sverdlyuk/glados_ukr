...
>  
> Це працює лише для пилососів Dreame. Модель можна знайти в [специфікації](https://home.miot-spec.com/). Так легко дізнатися, які голосові пакети підтримує твій Dreame.
